...
public class SuperCreeperEntity extends HostileEntity {
    ...
    public SuperCreeperEntity(EntityType<? extends SuperCreeperEntity> entityType, World world) {
        super(entityType, world);
        this.experiencePoints = 915;
    }

    protected void initGoals() {
        this.goalSelector.add(1, new SwimGoal(this));
        this.goalSelector.add(2, new SuperCreeperIgniteGoal(this));
    ...
    private void explode() {
        if (!this.world.isClient) {
            ...
            this.dead = true;
            this.world.createExplosion(this, this.getX(), this.getY(), this.getZ(), 24, destructionType);
            this.discard();
    ...
    public static DefaultAttributeContainer.Builder createMobAttributes() {
        return HostileEntity.createHostileAttributes()
                ...
                .add(EntityAttributes.GENERIC_FOLLOW_RANGE, 190);
    }
