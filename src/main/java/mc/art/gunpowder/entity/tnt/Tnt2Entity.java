...
public class Tnt2Entity extends Entity {
    private static final TrackedData<Integer> FUSE;
    @Nullable
    private LivingEntity causingEntity;

    public Tnt2Entity(EntityType<? extends Tnt2Entity> entityType, World world) {
        super(entityType, world);
        this.intersectionChecked = true;
    }

    public Tnt2Entity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(ModEntityType.LVL_2_TNT_ENTITY, world);
    ...
    private void explode() {
        float f = 8.0F;
        this.world.createExplosion(this, this.getX(), this.getBodyY(0.0625D), this.getZ(), 8.0F, DestructionType.BREAK);
    }
